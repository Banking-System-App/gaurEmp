...
function EmployeeSalaryStructure() {
  ...
  const handleSave = async () => {
    console.log(
      "Sorted data is ",
      salaryUtil.sortedSalaryData(salaryStructures)
    );
    console.log("Edited data Structure is ", editableData);
    try {
      await salaryApi
        .updateSalaryStructure(
          salaryUtil.sortedSalaryData(salaryStructures)[0].$id,
          editableData
        )
        .then((res) => {
          fetchEmployeeSalaryByEmpId();
          ...
          <MDBCard>
            <MDBCardBody>
              ...
              <MDBTable>
                ...
                <MDBTableBody>
                  {salaryUtil
                    .sortedSalaryData(salaryStructures)
                    .map((salaryStructure, index) => (
                      <tr key={index}>
                        {isEditMode ? (
                          <>
                            <td>
                            ...
                            <td>
                              <input
                                ...
                                onChange={(e) =>
                                  setEditableData({
                                    ...editableData,
                                    washing_allowance: e.target.value,
                                  })
                                }
                              />
                            </td>
              ...
              <div className="col-md-4 offset-md-4 text-center ">
                <div className="col-md-4 offset-md-4 mt-4 text-center">
                  {showAddForm || showMonthYear ? (
                    <></>
                  ) : (
                    <MDBBtn onClick={handleAddSalClick}>
                  ...
                  <form className="row g-3">
                    ...
                    <div className="row justify-content-center">
                      ...
                      <div className="col-md-4 text-center me-1" color="danger">
                        <MDBBtn
                          className="col-md-10 mt-4 me-1"
                          color="danger"
                          onClick={handleCancelAddSalaryStructure}
                        >
                          Cancel
                        </MDBBtn>
                      </div>
